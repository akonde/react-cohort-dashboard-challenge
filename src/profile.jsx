      ...
      <div className="form-container">
        ...
        <div className="form-div">
          ...
          <div className="address">
            ...
            <form>
              <label>Street</label>
              <input type="text" name="Street" placeholder="Avon  Williams" />
              <label> Suite</label>
              <input type="text" name="Suite" placeholder="Suite  654" />
              <label> City</label>
              <input type="text" name="City" placeholder="Wolveshamption" />
              <label> Zipcode</label>
              <input type="text" name="Zipcode" placeholder="WV6 0FA" />
            </form>
          </div>
          <div className="acc-info">
            <h3>Contact info</h3>
            <form>
              <label> Phone</label>
              <input type="text" name="Phone" placeholder="9906976444" />
              <label> Website</label>
              <input
                type="web"
                name="Website"
                placeholder="http://boolean.com"
              />
            </form>
          </div>
          <div className="acc-info">
